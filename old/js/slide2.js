...
for(let i = 0; i < slideContainer.length; i++){
    ...
    const slider = function () {
        ...
        const slides = slideContainer[i].querySelectorAll('.mySlide');  // Your code was : const slides = document.querySelectorAll('.slide');  don't search the entire document, only search the slider
